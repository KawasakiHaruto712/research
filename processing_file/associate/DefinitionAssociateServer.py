...
FormatPRFilePath = '/work/research/select_list/removal_bot/*/*.json'
...
def RequestAndAchieveAssociate(ReviewCommentsPath):
    ...
    # 出力するファイルパスの作成
    AssociateResultPath = '/work/research/select_list/RequestAssociateAF/' + AssociateFolderName + '/' + AssociateFileName + '.csv'
