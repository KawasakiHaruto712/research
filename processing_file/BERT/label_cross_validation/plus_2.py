...
for fold, (train_idx, test_idx) in enumerate(kf.split(df)):
    ...
    test_df = test_df[test_df["text"].str.contains("Code-Review\+2|Looks\sgood\sto\sme\s\(core\sreviewer\)", regex=True, na=False)]
    ...
    training_args = TrainingArguments(
        output_dir=f'../cross_validation/plus_2/results_fold_{fold}',
        num_train_epochs=3,
