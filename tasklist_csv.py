...
for i in tqdm(range(len(file_cate))):
    filepath_read = '/Users/haruto-k/research/select_list/task/json_file/' + file_cate[i] +'/*.json'
    ...
    for filepath in filepath_list:
        ...
        filepath_write = '/Users/haruto-k/research/select_list/task/csv_file/' + file_cate[i] + '/' + file_name + '.csv'
        # CSVファイルに書き込み
